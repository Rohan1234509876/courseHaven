...
// JWT string is inside userData.token.token
const token = userData?.token?.token;

// user info is inside userData.token.user
const currentUser = userData?.token?.user;
  ...
  useEffect(() => {
    const fetchBuyCourseData = async () => {
      try {
        ...
        console.log("ClientSecret from API:", response.data.clientSecret);
